...
save_as_icon = tk.PhotoImage(file='icons/saveas.png')
...
clear_all_icon = tk.PhotoImage(file='icons/clearall.png')
...
## font color button 
font_color_icon = tk.PhotoImage(file='icons/Untitled.png')
